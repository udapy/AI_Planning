...
class PlanningGraph():
    ...
    def add_action_level(self, level):
        ...
        '''
        old_s_level = self.s_levels[level] # Previous state level (previous to this level of actions)
        ...
        for action in actions:
            ...
            if a_node.prenodes.issubset(old	_s_level):
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        '''
        return bool(
            # node 1 negated by actions in node 2?
            set(node_a1.action.effect_add) & set(node_a2.action.effect_rem) |

            # node 2 negated by actions in node 1?
